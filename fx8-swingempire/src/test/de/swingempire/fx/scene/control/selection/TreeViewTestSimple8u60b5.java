 ...
 * 
 * changes
 * - commented, force-failed and conditionalIgnored tests with internal test code
 ...
 * - extracted all tree/View/item instantiation into factory methods
 * - test_rt_37061: replaced Integer type by string type 
 */
@SuppressWarnings({ "rawtypes", "unchecked" })
@RunWith(JUnit4.class)
public class TreeViewTestSimple8u60b5 {
    @ClassRule
    ...
    /**
     * Ignore tests that contain incorrect test assumptions.
     * 
...
//        sb.append(" \nAnchor: " + getAnchor());
    ...
    @Before public void setup() {
        ...
        myCompanyRootNode = createTreeItem("MyCompany Human Resources");
        salesDepartment = createTreeItem("Sales Department");
            ethanWilliams = createTreeItem("Ethan Williams");
            emmaJones = createTreeItem("Emma Jones");
            michaelBrown = createTreeItem("Michael Brown");
            annaBlack = createTreeItem("Anna Black");
            rodgerYork = createTreeItem("Rodger York");
            susanCollins = createTreeItem("Susan Collins");

        itSupport = createTreeItem("IT Support");
            mikeGraham = createTreeItem("Mike Graham");
            judyMayer = createTreeItem("Judy Mayer");
            gregorySmith = createTreeItem("Gregory Smith");
    ...
    private void installChildren() {
        ...
        child1 = createTreeItem("Child 1");
        child2 = createTreeItem("Child 2");
        child3 = createTreeItem("Child 3");
...
//        assertStyleClassContains(treeView, "tree-view");
    ...
    @Test public void singleArgConstructorSetsTheStyleClass() {
        fail("TBD - internal test api");
        final TreeView<String> b2 = createTreeView(createTreeItem("Hi"));
//        assertStyleClassContains(b2, "tree-view");
    ...
    @Test public void singleArgConstructorAllowsNullItems() {
        final TreeView<String> b2 = createTreeView(null);
        assertNull(b2.getRoot());
    }

    @Test public void singleArgConstructor_selectedItemIsNotNull() {
        TreeItem<String> hiItem = createTreeItem("Hi");
        final TreeView<String> b2 = createTreeView(hiItem);
...
//        assertSame(sm, treeView.getSelectionModel());
    ...
    @Test public void canSetSelectedItemToAnItemEvenWhenThereAreNoItems() {
        TreeItem<String> element = createTreeItem("I AM A CRAZY RANDOM STRING");
...
//    @Ignore("Not yet supported")
    @Test public void ensureSelectedItemRemainsAccurateWhenItemsAreCleared() {
        ...
        TreeItem<String> newRoot = createTreeItem("New Root");
        TreeItem<String> newChild1 = createTreeItem("New Child 1");
        TreeItem<String> newChild2 = createTreeItem("New Child 2");
    ...
    @Test public void ensureSelectionIsCorrectWhenItemsChange() {
        ...
        TreeItem newRoot = createTreeItem("New Root");
    ...
    @Test public void removingLastTest() {
        TreeView tree_view = createTreeView();
        MultipleSelectionModel sm = tree_view.getSelectionModel();
        TreeItem<String> tree_model = createTreeItem("Root");
        TreeItem node = createTreeItem("Data item");
...
//    @Ignore 
    ...
    @Test public void test_rt17112() {
        ...
        final TreeView treeView1 = createTreeView();
    ...
    private void addChildren(TreeItem parent, String name) {
        for (int i=0; i<3; i++) {
            TreeItem<String> ti = createTreeItem(name+"-"+i);
    ...
    @Test public void test_rt17522_focusShouldMoveWhenItemAddedAtFocusIndex() {
        ...
        TreeItem child0 = createTreeItem("child0");
    ...
    @Test public void test_rt17522_focusShouldMoveWhenItemAddedBeforeFocusIndex() {
        ...
        // PENDING JW: focus changes not easily testable?
//        assertTrue("Focused index: " + fm.getFocusedIndex(), fm.isFocused(2));
    ...
    @Test public void test_rt17522_focusShouldNotMoveWhenItemAddedAfterFocusIndex() {
        ...
        TreeItem child4 = createTreeItem("child4");
...
//        table.getItems().addAll("row1", "row2", "row3");
        ...
        treeView.getRoot().getChildren().add(createTreeItem("Another Row"));
    ...
    @Test public void test_rt21586() {
        ...
        TreeItem root = createTreeItem("New Root");
        TreeItem child1 = createTreeItem("New Child 1");
        TreeItem child2 = createTreeItem("New Child 2");
        TreeItem child3 = createTreeItem("New Child 3");
        root.setExpanded(true);
        root.getChildren().setAll(child1, child2, child3);
        treeView.setRoot(root);
        assertEquals(-1, treeView.getSelectionModel().getSelectedIndex());
...
//    @Ignore("Bug hasn't been fixed yet")
    ...
    @Test public void test_rt27820_1() {
        TreeItem root = createTreeItem("root");
        root.setExpanded(true);
        TreeItem child = createTreeItem("child");
...
//                createTreeItem(new Person("Jacob", "Smith", "jacob.smith@example.com")),
//                createTreeItem(new Person("Isabella", "Johnson", "isabella.johnson@example.com")),
//                createTreeItem(new Person("Ethan", "Williams", "ethan.williams@example.com")),
//                createTreeItem(new Person("Emma", "Jones", "emma.jones@example.com")),
//                createTreeItem(new Person("Michael", "Brown", "michael.brown@example.com")));
//        root.setExpanded(true);
//        
//        TreeView<Person> tree = createTreeView<Person>(root);
//        
...
//        // to be empty
//        root.getChildren().setAll(
//                createTreeItem(new Person("*_*Emma", "Jones", "emma.jones@example.com")),
//                createTreeItem(new Person("_Michael", "Brown", "michael.brown@example.com")));
//        
...
//    
//        TreeItem<String> rootNode = createTreeItem("MyCompany Human Resources");
//        rootNode.setExpanded(true);
//        
//        List<TreeItem<String>> nodeList = FXCollections.observableArrayList();
//        for (Employee employee : employees) {
//            nodeList.add(createTreeItem(employee.getName()));
//        }
//        rootNode.getChildren().setAll(nodeList);
//
//        TreeView<String> treeView = createTreeView(rootNode);
//        
...
//        TreeItem<RT_22463_Person> root = createTreeItem<RT_22463_Person>(rootPerson);
//        root.setExpanded(true);
//        
//        final TreeView<RT_22463_Person> tree = createTreeView<RT_22463_Person>();
//        tree.setRoot(root);
//        
...
//                createTreeItem<RT_22463_Person>(p1), 
//                createTreeItem<RT_22463_Person>(p2));
...
//        root.getChildren().setAll(
//                createTreeItem<RT_22463_Person>(new_p1), 
//                createTreeItem<RT_22463_Person>(new_p2));
...
//        VirtualFlowTestUtils.assertCellTextEquals(tree, 2, "updated name2");
    ...
    @Test public void test_rt28637() {
        ...
        ObservableList<TreeItem<String>> items = FXCollections.observableArrayList(
                s1 = createTreeItem("String1"), 
                s2 = createTreeItem("String2"), 
                s3 = createTreeItem("String3"), 
                s4 = createTreeItem("String4"));
...
//                createTreeItem<Person>(new Person("Jacob", "Smith", "jacob.smith@example.com")),
//                createTreeItem<Person>(new Person("Isabella", "Johnson", "isabella.johnson@example.com")),
//                createTreeItem<Person>(new Person("Ethan", "Williams", "ethan.williams@example.com")),
//                createTreeItem<Person>(new Person("Emma", "Jones", "emma.jones@example.com")),
//                createTreeItem<Person>(new Person("Jacob", "Smith", "jacob.smith@example.com")),
//                createTreeItem<Person>(new Person("Isabella", "Johnson", "isabella.johnson@example.com")),
//                createTreeItem<Person>(new Person("Ethan", "Williams", "ethan.williams@example.com")),
//                createTreeItem<Person>(new Person("Emma", "Jones", "emma.jones@example.com")),
...
//        ));
//                
//        TreeView<Person> treeView = createTreeView();
//        treeView.setMaxHeight(50);
//        treeView.setPrefHeight(50);
//        
//        TreeItem<Person> root = createTreeItem<Person>(new Person("Root", null, null));
//        root.setExpanded(true);
//        treeView.setRoot(root);
//        treeView.setShowRoot(false);
...
//        TreeItem<String> rootItem = createTreeItem("root");
...
//        sl.dispose();
    ...
    @Test public void test_rt34103() {
        treeView.setRoot(createTreeItem("Root"));
        treeView.getRoot().setExpanded(true);

        for (int i = 0; i < 4; i++) {
            TreeItem parent = createTreeItem("item - " + i);
            treeView.getRoot().getChildren().add(parent);

            for (int j = 0; j < 4; j++) {
                TreeItem child = createTreeItem("item - " + i + " " + j);
...
//        assertEquals(3, treeView.getFocusModel().getFocusedIndex());
    ...
    @Test public void test_rt34694() {
        TreeItem treeNode = createTreeItem("Controls");
        treeNode.getChildren().addAll(
            createTreeItem("Button"),
            createTreeItem("ButtonBar"),
            createTreeItem("LinkBar"),
            createTreeItem("LinkButton"),
            createTreeItem("PopUpButton"),
            createTreeItem("ToggleButtonBar")
        );

        final TreeView treeView = createTreeView();
        ...
        treeNode.getChildren().addAll(
                createTreeItem("Button1"),
                createTreeItem("ButtonBar1"),
                createTreeItem("LinkBar1"),
                createTreeItem("LinkButton1"),
                createTreeItem("PopUpButton1"),
                createTreeItem("ToggleButtonBar1")
        );
        Toolkit.getToolkit().firePulse();
    ...
    @Test public void test_rt35213() {
        final TreeView<String> view = createTreeView();

        TreeItem<String> root = createTreeItem("Boss");
        view.setRoot(root);

        TreeItem<String> group1 = createTreeItem("Group 1");
        TreeItem<String> group2 = createTreeItem("Group 2");
        TreeItem<String> group3 = createTreeItem("Group 3");

        root.getChildren().addAll(group1, group2, group3);

        TreeItem<String> employee1 = createTreeItem("Employee 1");
        TreeItem<String> employee2 = createTreeItem("Employee 2");
...
//                System.out.println("------------------------------------------");
    ...
    @Test public void test_rt23245_itemIsInTree() {
        ...
        for (int i = 0; i < 10; i++) {
            final TreeItem<String> item = createTreeItem("Item" + i);
    ...
    @Test public void test_rt23245_itemIsNotInTree_withUnrelatedRootNode() {
        ...
        view.setRoot(createTreeItem("Unrelated root node"));
    ...
    @Test public void test_rt35857() {
        TreeItem<String> root = createTreeItem("Root");
        root.setExpanded(true);
        TreeItem a = createTreeItem("A");
        TreeItem b = createTreeItem("B");
        TreeItem c = createTreeItem("C");
        root.getChildren().setAll(a, b, c);

        final TreeView<String> treeTableView = createTreeView(root);
...
//
//        final TreeView<String> textFieldTreeView = createTreeView(root);
...
//        assertEquals(0, rt_35889_cancel_count);
    ...
    @Test public void test_rt36255_selection_does_not_expand_item() {
        TreeItem a = createTreeItem("a");
        TreeItem b = createTreeItem("b");
        b.getChildren().add(createTreeItem("bb"));

        final TreeItem<String> root = createTreeItem();
        root.getChildren().addAll(a, b);
        root.setExpanded(true);
        TreeView<String> view = createTreeView(root);
    ...
    @Test public void test_rt25679() {
        ...
        TreeItem<String> root = createTreeItem("Root");
        root.getChildren().setAll(createTreeItem("a"), createTreeItem("b"));
        root.setExpanded(true);

        final TreeView<String> treeView = createTreeView(root);
    ...
    private void test_rt36885(boolean addChildToAAfterSelection) {
        TreeItem<String> root = createTreeItem("Root");     // 0
            TreeItem<String> a = createTreeItem("a");       // 1
                TreeItem<String> a1 = createTreeItem("a1"); // a expanded = 2, a collapsed = -1
            TreeItem<String> b = createTreeItem("b");       // a expanded = 3, a collapsed = 2
                TreeItem<String> b1 = createTreeItem("b1"); // a expanded = 4, a collapsed = 3
                TreeItem<String> b2 = createTreeItem("b2"); // a expanded = 5, a collapsed = 4
...
//        assertEquals(b1, fm.getFocusedItem());
    ...
    @Test public void test_rt_37061() {
        fail("TBE: Integer items");
//        TreeItem root = createTreeItem(0);
//        root.setExpanded(true);
//        TreeView tv = createTreeView();
//        tv.setRoot(root);
...
//        tv.getRoot().getChildren().add(createTreeItem("1"));
...
//        assertEquals(0, rt_37061_item_counter);
    ...
    /**
     * Incorrect test assumption: there's _never_ a permutation on the indices except
     * the odd corner case when all indices are selected. Which isn't the case here.
     */
    @ConditionalIgnore(condition = IgnoreIncorrectTestAssumption.class)
    @Test public void test_rt_37395() {
        // tree items - 3 items, 2nd item has 2 children
        TreeItem<String> root = createTreeItem();

        TreeItem<String> two = createTreeItem("two");
        two.getChildren().add(createTreeItem("childOne"));
        two.getChildren().add(createTreeItem("childTwo"));

        root.getChildren().add(createTreeItem("one"));
        root.getChildren().add(two);
        root.getChildren().add(createTreeItem("three"));
...
//    @Ignore("Fix not yet developed for TreeView")
    ...
    private void test_rt_35395(boolean useFixedCellSize) {
        ...
        TreeItem<String> root = createTreeItem("green");
        root.setExpanded(true);
        for (int i = 0; i < 20; i++) {
            root.getChildren().addAll(createTreeItem("red"), createTreeItem("green"), createTreeItem("blue"), createTreeItem("purple"));
        }

        TreeView<String> treeView = createTreeView(root);
        if (useFixedCellSize) {
        ...
        Platform.runLater(() -> {
            rt_35395_counter = 0;
            root.getChildren().set(10, createTreeItem("yellow"));
            Platform.runLater(() -> {
                Toolkit.getToolkit().firePulse();
                assertEquals(1, rt_35395_counter);
                rt_35395_counter = 0;
                root.getChildren().set(30, createTreeItem("yellow"));
                Platform.runLater(() -> {
                    Toolkit.getToolkit().firePulse();
    ...
    @Test public void test_rt_37632() {
        final TreeItem<String> rootOne = createTreeItem("Root 1");
        final TreeItem<String> rootTwo = createTreeItem("Root 2");
    ...
    private void test_rt_37853(boolean replaceRoot) {
        ...
        for (int i = 0; i < 10; i++) {
            treeView.getRoot().getChildren().add(createTreeItem("" + i));
        }
        ...
        if (replaceRoot) {
            treeView.setRoot(createTreeItem("New Root"));
        } else {
            treeView.getRoot().getChildren().clear();
            for (int i = 0; i < 10; i++) {
                treeView.getRoot().getChildren().add(createTreeItem("new item " + i));
            }
        }
    ...
    private void test_rt_38787(String expectedItem, int expectedIndex, int... indicesToRemove) {
        ...
        TreeView<String> stringTreeView = createTreeView(root);
...
//        stringTableView.getColumns().add(column);
    ...
    @Test public void test_rt_38341() {
        Callback<Integer, TreeItem<String>> callback = number -> {
            ...
            final TreeItem<String> child = createTreeItem("Child " + number);
    ...
    @Test public void test_rt_38884() {
        ...
        final TreeItem<String> foo = createTreeItem("foo");
    ...
    @Test public void test_rt_37366() {
        ...
        final TreeItem<String> root1 = createTreeItem("Root Node 1");
        root1.getChildren().addAll(createTreeItem("Item 1"), treeItem2, createTreeItem("Item 3"));
        root1.setExpanded(true);

        final TreeItem<String> root2 = createTreeItem("Root Node 2");

        final TreeItem<String> hiddenRoot = createTreeItem("Hidden Root Node");
        hiddenRoot.getChildren().add(root1);
        hiddenRoot.getChildren().add(root2);

        final TreeView<String> treeView = createTreeView(hiddenRoot);
        // PENDING JW: TreeIndicesList cannot handle intertwined tree modifications
        // here: force root expansion + hiding root
        // so add expansion first (the issue is covered in AbstractTreeMultipleSelectionIssues)
...
//        root.getChildren().add(0, createTreeItem("z"));
//
...
//        assertEquals(root.getChildren().get(expectedIndex).getValue(), fm.getFocusedItem().getValue());
    ...
    private ObservableList<String> test_rt_39661_setup() {
        ...
        root.setExpanded(true);
        treeView = createTreeView(root);
        return rawItems;
    }

    private TreeItem createSubTree(String item, ObservableList<String> rawItems) {
        TreeItem child = createTreeItem(item);
        child.getChildren().setAll(rawItems.stream()
                .map(rawItem -> createTreeItem(rawItem))
    ...
    @Test public void test_rt_22599() {
        fail("TBD - internal test api");
//        TreeItem<RT22599_DataType> root = createTreeItem();
//        root.getChildren().setAll(
//                createTreeItem(new RT22599_DataType(1, "row1")),
//                createTreeItem(new RT22599_DataType(2, "row2")),
//                createTreeItem(new RT22599_DataType(3, "row3")));
//        root.setExpanded(true);
//
//        TreeView<RT22599_DataType> tree = createTreeView(root);
//        tree.setShowRoot(false);
//
//        StageLoader sl = new StageLoader(tree);
//
...
//        root.getChildren().set(0, data = createTreeItem(new RT22599_DataType(0, "row1a")));
//        Toolkit.getToolkit().firePulse();
