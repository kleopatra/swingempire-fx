...
//        getSkinnable().requestLayout();
    ...
    /**
     * PENDING JW
     * Hack around not-visible method, no-op for now
     */
        ...
        final ListView<T> _listView = new ListView<T>() {
            ...
            @Override protected double computePrefWidth(double height) {
                ...
                if (getSkin() instanceof ListViewSkin) {
                    ...
                    pw = Math.max(comboBox.getWidth(), invokeGetMaxCellWidth(skin, rowsToMeasure) + 30);
                } else {
            ...
            /**
             * PENDING JW: hack around not visible super method,
             * hard-coded for now.
             */
...
//            comboBox.accSendNotification(Attribute.TITLE);
    ...
    /**
     * PENDING JW: 
     * Hack around invisibl method, hardcoded to maxRows * 20 for now.
     * @param maxRows
     * @param skin
     * @return
     */
