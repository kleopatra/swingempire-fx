 ...
 *  
 * Here we move the responsibility to the SelectionModel (aka: primary 
 * controller): it either has
 * to update the focus internally or pass-on the List.Change to this class. 
 * 
