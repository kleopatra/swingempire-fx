...
/**
 * Plain copy of VirtualFlow except for widening scopr of
 ...
 * @since 9
 */
public class VirtualFlow9<T extends IndexedCell> extends Region {
     ...
     * ONLY for testing.
     */
    private VirtualScrollBar9 hbar = new VirtualScrollBar9(this);

    /**
     * The scroll bar used to scrolling vertically. This has package access
     * ONLY for testing.
     */
    private VirtualScrollBar9 vbar = new VirtualScrollBar9(this);
            ...
            public void handle(MouseEvent e) {
                ...
                if (isFocusTraversable()) {
                    ...
                    if (focusOwner != null) {
                        ...
                        while (parent != null) {
                            if (parent.equals(VirtualFlow9.this)) {
...
//        vbar.addChangedListener(ScrollBar.VALUE, listenerY);
    ...
    private IntegerProperty cellCount = new SimpleIntegerProperty(this, "cellCount", 0) {
        ...
        @Override protected void invalidated() {
            ...
            // cell count.
            if (countChanged) {
                VirtualScrollBar9 lengthBar = isVertical() ? vbar : hbar;
    ...
    // --- Cell Factory
    private ObjectProperty<Callback<VirtualFlow9<T>, T>> cellFactory;
     ...
     */
    public final void setCellFactory(Callback<VirtualFlow9<T>, T> value) {
     ...
     */
    public final Callback<VirtualFlow9<T>, T> getCellFactory() {
     ...
     */
    public final ObjectProperty<Callback<VirtualFlow9<T>, T>> cellFactoryProperty() {
        if (cellFactory == null) {
            cellFactory = new SimpleObjectProperty<Callback<VirtualFlow9<T>, T>>(this, "cellFactory") {
                @Override protected void invalidated() {
                    if (get() != null) {
                        accumCell = null;
                        setNeedsLayout(true);
...
//    }
    ...
    public T getCell(int index) {
        ...
        if (accumCell == null) {
            Callback<VirtualFlow9<T>,T> cellFactory = getCellFactory();
            if (cellFactory != null) {
    ...
    protected final VirtualScrollBar9 getHbar() {
        return hbar;
    }
    protected final VirtualScrollBar9 getVbar() {
        return vbar;
    }
    ...
    private boolean computeBarVisiblity() {
        ...
        VirtualScrollBar9 breadthBar = isVertical ? hbar : vbar;
        VirtualScrollBar9 lengthBar = isVertical ? vbar : hbar;
...
//            }
    ...
    private boolean doesCellContainFocus(Cell<?> c) {
        ...
        if (focusOwner != null) {
            ...
            while (p != null && ! (p instanceof VirtualFlow9)) {
                if (c.equals(p)) {
                    return true;
                }
                p = p.getParent();
...
//    }
    ...
    static class ClippedContainer extends Region {
        ...
        public ClippedContainer(final VirtualFlow9<?> flow) {
            if (flow == null) {
