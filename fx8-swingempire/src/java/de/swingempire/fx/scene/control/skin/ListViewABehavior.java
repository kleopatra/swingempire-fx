...
/**
 * 
 * On the move to fx-9: trying to factor out the variance between fx-9 and fx-8
 * 
 * Here we were coming from the fx-8 version
 * - build up the inheritance stack over patch/patch8
 * - moved fx-8 keyBindings code into a factory (plain string-mapped, hard-coded!)
 * - TODO: remove all accesss to com.xx
 * - 
 * 
 * ---------
